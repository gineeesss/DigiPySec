<!-- resources/views/livewire/admin/servicios/create.blade.php -->
<div>
    <x-slot name="header">
        ...
        <form wire:submit.prevent="save">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-1">
                    ...
                    <input wire:model="nombre" type="text" id="nombre" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
...
<div class="col-span-1">
    ...
    <select wire:model="categoria_id" id="categoria_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
...
<div class="col-span-2">
    ...
    <textarea wire:model="descripcion" id="descripcion" rows="4" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"></textarea>
...
<div class="col-span-1">
    ...
    <input wire:model="precio" type="number" step="0.01" min="0" id="precio" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
...
<div class="col-span-1">
    ...
    <input wire:model="imagen" type="file" id="imagen" class="w-full">
    ...
    <div class="space-y-2">
        @foreach($caracteristicas as $index => $caracteristica)
            <div class="flex items-center">
                <input wire:model="caracteristicas.{{ $index }}" type="text" class="flex-grow rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
