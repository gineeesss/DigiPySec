<div>
    <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            <h2 class="text-2xl font-semibold text-gray-800 mb-6">Editar Solicitud #{{ $solicitud->id }}</h2>

            <form wire:submit.prevent="actualizarSolicitud">
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('admin.solicitudes.index') }}" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300">
                        Cancelar
                    </a>
