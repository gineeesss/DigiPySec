<!-- resources/views/livewire/solicitud/solicitud-list.blade.php -->
<div>
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex flex-col md:flex-row md:items-center md:justify-between">
                <h2 class="text-xl font-semibold text-gray-800 mb-4 md:mb-0">Solicitudes de Servicios</h2>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    @forelse($solicitudes as $solicitud)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $solicitud->cliente->nombre ?? 'Sin cliente' }}</div>
                                <div class="text-sm text-gray-500">{{ $solicitud->cliente->email ?? '' }}</div>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500">No se encontraron solicitudes</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
